...
FontParts is an *API* for programatically creating and editing parts of fonts during the type design process. It is application independent to allow scripts to be portable across multiple applications. It ***may*** be a replacement for `RoboFab <http://robofab.org>`_.
